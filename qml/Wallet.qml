    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                radius: 6
                color: buttonBackupKeys.down ? "#ce9f52" : "#000000"
            }
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive NaK"
    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonExportListTransactions.down ? "#ce9f52" : "#000000"
            }
    ...
    Rectangle {
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonSavedAddress.down ? "#ce9f52" : "#000000"
            }
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonSaveAddress.down ? "#ce9f52" : "#000000"
            }
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonFullBalance.down ? "#ce9f52" : "#000000"
            }
        ...
        Button {
            ...
            background: Rectangle {
                ...
                opacity: enabled ? 1 : 0.3
                radius: 6
                color: buttonSend.down ? "#ce9f52" : "#000000"
            }
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " NaK + " + rectangleTransfer.transferFee + " (fee) + " + rectangleTransfer.nodeFeeValue + " (node fee)", rectangleTransfer.transferPaymentID);
            }
        }
